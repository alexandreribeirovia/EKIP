...
const Allocations = () => {
  ...
  useEffect(() => {
    const styleId = 'sticky-horizontal-scroll-styles';
    ...
    style.id = styleId;
    style.textContent = `
      /* Torna o scroll horizontal do timeline fixo na parte inferior */
      ...
      /* Ajusta o container para permitir scroll fixo */
      #calendar-container {
        position: relative;
      }
      
      /* Garante que o scroll seja visível */
      .fc-timeline-body .fc-scroller::-webkit-scrollbar {
        height: 12px;
      }
      
      .fc-timeline-body .fc-scroller::-webkit-scrollbar-track {
        background: #f1f1f1;
        border-top: 1px solid #e5e7eb;
      }
      
      .fc-timeline-body .fc-scroller::-webkit-scrollbar-thumb {
        background: #888;
        border-radius: 6px;
      }
      
      .fc-timeline-body .fc-scroller::-webkit-scrollbar-thumb:hover {
        background: #555;
      }
      
      /* Adiciona sombra para destacar o scroll fixo */
      .fc-timeline-body .fc-scroller {
